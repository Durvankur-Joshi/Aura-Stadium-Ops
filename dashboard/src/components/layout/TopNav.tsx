...
export const TopNav: React.FC = () => {
  return (
    <header className="h-16 bg-aura-card border-b border-gray-800 flex items-center justify-between px-6 z-10">
      <div className="flex items-center bg-gray-900/50 rounded-full px-4 py-2 w-96 border border-gray-700 focus-within:border-aura-primary focus-within:ring-2 focus-within:ring-aura-primary transition-all">
      ...
      <div className="flex items-center space-x-4">
        <a 
          ...
          aria-label="Launch Fan App in a new tab"
          className="flex items-center space-x-2 bg-gradient-to-r from-aura-primary to-aura-accent hover:opacity-90 text-white px-4 py-1.5 rounded-lg shadow-lg shadow-aura-primary/20 transition-all font-medium text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-aura-primary"
        >
        ...
        <button 
          ...
          className="relative p-2 text-gray-400 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-aura-primary focus:ring-offset-2 focus:ring-offset-gray-900 rounded-full"
        >
